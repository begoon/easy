...
Field a(Field f)
{
    ...
    $index(10, 1, 100, &$F, 10, 50);
    const STR $r3 = $concat("AiAA", $0, f.data[(10) - (1)].score, $1, f.data[(10) - (1)].name);
    $output("A", $r3);
    ...
    $index(10, 1, 100, &$F, 12, 25);
    const STR $r4 = $concat("AA", f.data[(10) - (1)].name, $2);
    f.data[(10) - (1)].name = $r4;
    return f;
}
int main_program()
{
    ...
    $index(10, 1, 100, &$F, 19, 47);
    const STR $r2 = $concat("AiAA", $4, f.data[(10) - (1)].score, $1, f.data[(10) - (1)].name);
    $output("A", $r2);
    exit(0);
}
